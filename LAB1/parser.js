...
// Define la expresión regular a utilizar
var regex = '(x|t)+((a|m)?)+';

// Crea el NFA a partir de la expresión regular
var nfa = regexToNfa(regex);

// Crea el DFA a partir del NFA
var dfa = nfaToDfa(nfa);

// Minimiza el DFA
var minDfa = minDfa(dfa);

// Muestra los resultados en la consola
console.log('Expresión regular:', regex);
console.log('parsed:', parseRegex(regex));
console.log('NFA:', nfa);
console.log('DFA:', dfa);
console.log('DFA minimizado:', minDfa);
